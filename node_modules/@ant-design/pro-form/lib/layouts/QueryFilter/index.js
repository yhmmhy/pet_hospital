...
var QueryFilterContent = function QueryFilterContent(props) {
  ...
  var processedList = flatMapItems(items, props.ignoreRules, form).map(function (item, index) {
    ...
    var colSize = /*#__PURE__*/_react.default.isValidElement(item) ? (_item$props$colSize = item === null || item === void 0 || (_item$props4 = item.props) === null || _item$props4 === void 0 ? void 0 : _item$props4.colSize) !== null && _item$props$colSize !== void 0 ? _item$props$colSize : 1 : 1;
